...
var ErrScheduleNotFound = diagnostic.NewDiagnosticError("SS0013", diagnostic.RecoveryPermanent,
	"schedule not found",
...
var ErrScheduleDeclarationInterrupted = diagnostic.NewDiagnosticError("SS0025", diagnostic.RecoveryTransient,
