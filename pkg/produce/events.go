...
var EventPartitionNotCreatedAhead = diagnostic.NewDiagnosticEvent("SS0033",
...
// outran its triggers.
var EventPartitionCreatedOnInsert = diagnostic.NewDiagnosticEvent("SS0057",
...
var EventSlowProduce = diagnostic.NewDiagnosticEvent("SS0038",
