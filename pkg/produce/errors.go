...
var ErrPartitionLockTimeout = diagnostic.NewDiagnosticError("SQL0018", diagnostic.RecoveryTransient,
...
var ErrPartitionCreationBehind = diagnostic.NewDiagnosticError("SQL0056", diagnostic.RecoveryPermanent,
