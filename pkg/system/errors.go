...
var ErrSystemLive = diagnostic.NewDiagnosticError("SQL0010", diagnostic.RecoveryPermanent,
...
var ErrStreamsRegistered = diagnostic.NewDiagnosticError("SQL0011", diagnostic.RecoveryPermanent,
	"streams are still registered",
...
var ErrSchemaNotCreatable = diagnostic.NewDiagnosticError("SQL0064", diagnostic.RecoveryPermanent,
