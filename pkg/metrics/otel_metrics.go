...
var MetricOTelSourceReadSuccess = diagnostic.NewDiagnosticMetric("VK0102",
	...
	"whether the adapter read retained measurements successfully", diagnostic.MetricScopeSystem)
...
var MetricOTelMeasurementsRejected = diagnostic.NewDiagnosticMetric("VK0103",
	...
	"retained measurements omitted from the current export", diagnostic.MetricScopeSystem)
