...
var ErrInstanceLost = diagnostic.NewDiagnosticError("SS0012", diagnostic.RecoveryPermanent,
...
var ErrWorkerDeclarationInterrupted = diagnostic.NewDiagnosticError("SS0024", diagnostic.RecoveryTransient,
