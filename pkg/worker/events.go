...
var EventInstanceLost = diagnostic.NewDiagnosticEvent("SQL0034",
...
var EventManagerRowSuspended = diagnostic.NewDiagnosticEvent("SQL0035",
...
var EventTickBackoffCurveExhausted = diagnostic.NewDiagnosticEvent("SQL0036",
...
var EventSlowTick = diagnostic.NewDiagnosticEvent("SQL0040",
...
var EventWorkerConfigReplaced = diagnostic.NewDiagnosticEvent("SQL0059",
