...
func (c *MetricController) AbandonedRoutineSnapshot(ctx context.Context, topicId int64, group string) (*metric.AbandonedRoutineSnapshot, error) {
	if topicId <= 0 {
	...
	routingKey := metric.AbandonedRoutineKey(topicId, group)
