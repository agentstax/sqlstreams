...
func (d *MetricDatastore) TopicSnapshot(ctx context.Context, topicId int64) (*TopicSnapshotRow, error) {
...
func (d *MetricDatastore) SchemaVersionCounts(ctx context.Context, topicId int64) ([]SchemaVersionCountRow, error) {
...
func (d *MetricDatastore) schemaVersionCounts(ctx context.Context, topicId int64) ([]SchemaVersionCountRow, error) {
	sql := fmt.Sprintf(`
		-- vulkan: metric.schemaVersionCounts
		SELECT
			m.schema_version,
			count(*) AS messages,
...
func (d *MetricDatastore) ConsumerGroupSchemaVersionLag(ctx context.Context, topicId int64, schemaVersion int64) ([]ConsumerGroupSchemaVersionLagRow, error) {
...
func (d *MetricDatastore) groupSchemaVersionLag(ctx context.Context, topicId int64, schemaVersion int64) ([]ConsumerGroupSchemaVersionLagRow, error) {
	sql := fmt.Sprintf(`
		-- vulkan: metric.groupSchemaVersionLag
		SELECT
