...
- partitions, retention, janitor, create-ahead, heal, drop floor: 0221-0227 0378-0384 0428 0512-0513 0620
- topic catalog, schema version, rename, alter, per-topic tables, table names: 0241-0248 0348-0353 0401-0411 0570-0572 0611 0613 0618 0624 0628
- compaction, message key, rank, ordered/exclusive/parallel, key lease, deadlock: 0261-0273 0403 0463 0574 0612 0617
...
- errors (VK codes, fix, diagnose), logging (levels, buffer, suppression, stop line), metrics declarations: 0302-0305 0326 0522-0524 0550-0554 0558-0569 0589-0590 0647-0648
...
- packages, layers, seams, naming, receivers, file layout, configs, constructors: 0441-0451 0507-0510 0528-0549 0555-0557 0643-0646
- declarations: newest-wins, CLI never writes config, worker metadata: 0515-0521 0626
- client shape, handles, Register, lifecycle ctx, shutdown: 0361-0377 0625 0633-0646
