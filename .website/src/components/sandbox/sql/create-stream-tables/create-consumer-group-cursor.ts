...
export function createConsumerGroupCursorSql(streamId: number): string {
	return interpolate(createConsumerGroupCursorSqlTemplate, consumerGroupCursorTable(streamId));
}
