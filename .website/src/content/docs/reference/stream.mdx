...
| verb | returns | notes |
| --- | --- | --- |
| `Register(ctx, cfg)` | `*Stream` | declares the stream and creates its tables on first registration; idempotent; `nil` cfg is the defaults; a differing redeclaration logs [SS0061](/errors/SS0061/) |
