...
`vulkantest.NewClient(t)` stands the real library up in a schema it drops
at cleanup, so a handler test runs against Postgres and nothing fake. The
spec is the [vulkantest reference](/reference/vulkantest/). Not built.
