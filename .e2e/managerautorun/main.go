...
func run() (err error) {
	...
	fmt.Println("\n✅ MANAGER AUTO-RUN E2E TEST PASSED")
...
// row -- a group's manager rows are unbounded and are not this e2e test's subject.
...
// captureLogger counts declared codes by level -- e2e tests assert on events by
