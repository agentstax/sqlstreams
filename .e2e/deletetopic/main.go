...
// DeleteTopic cascade e2e test: confirms Destroy doesn't just drop message_log and
...
const group = "phase9.deletetopic.group"
...
func run() (err error) {
	...
	topicName := fmt.Sprintf("phase9.deletetopic.%d", time.Now().UnixNano())
	...
	fmt.Println("\n✅ DELETE TOPIC CASCADE E2E TEST PASSED")
